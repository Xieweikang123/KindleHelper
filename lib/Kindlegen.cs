...
namespace KindleHelper
{
    public class Kindlegen
    {
        ...
        public static void Book2Txt(Book2 book,string savePath)
        {
            string txt = "";
        ...
        public static void Book2Mobi(Book2 book,string savePath)
        {
            LoadTemplates();
            //create tmp
        ...
        static void CreateCover(Book2 book)
        {
        ...
        static void CreateChapters(Book2 book)
        {
            for (int i = 0; i < book.chapters.Length; i++) {
        ...
        static void CreateStyle(Book2 book)
        {
            string path = "./tmp/style.css";
            File.WriteAllText(path,tpl_style);
        }

        static void CreateBookToc(Book2 book)
        {
        ...
        static void CreateNaxToc(Book2 book)
        {
        ...
        static void CreateOpf(Book2 book) {
